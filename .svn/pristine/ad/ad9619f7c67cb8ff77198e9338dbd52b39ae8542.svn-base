...
namespace BLL.FunctionClasses.Transaction
{
    public class ItemSales
    {
        ...
        public int Save(Item_Sales pClsProperty)
        {
            Request Request = new Request();

            Request.AddParams("@ItemSalesID", pClsProperty.ItemSalesID, DbType.Decimal, ParameterDirection.Input);
            Request.AddParams("@ItemSalesMasterID", pClsProperty.ItemSalesMasterID, DbType.Decimal, ParameterDirection.Input);
            ...
            Request.CommandText = "Item_Sales_Save";
            Request.CommandType = CommandType.StoredProcedure;
            return Ope.ExecuteNonQuery(BLL.DBConnections.ConnectionString, BLL.DBConnections.ProviderName, Request);

        }

        public DataTable GetData(int ItemSalesMasterID)
        {
            DataTable DTab = new DataTable();
            Request Request = new Request();

            Request.AddParams("@ItemSalesMasterID", ItemSalesMasterID, DbType.Int32, ParameterDirection.Input);

            Request.CommandText = "Item_Sales_Search_GetData";
            Request.CommandType = CommandType.StoredProcedure;

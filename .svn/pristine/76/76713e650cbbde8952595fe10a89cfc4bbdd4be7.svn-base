...
{
    public partial class FrmItemSaleMaster : Form
    {
        ...
        public FrmItemSaleMaster(string Type_)
        {
            InitializeComponent();
            Form_Type = Type_;
        }
        ...
        public Invoice_EntryProperty SaveItemPurchaseMaster()
        {
            ...
            Invoice_EntryProperty.BillTo_Party_Code = Val.ToInt64(LookupBillToParty.EditValue);
        ...
        {
            isEditMode = false;
            chkToPartySame.Checked = false;
            LookupBillToParty.EditValue = null;
            ...
            string Invoice_No = Val.ToString(ObjInvoiceEntry.GEtMaximumID_New("Sales"));
        ...
        private void FrmItemPurchaseMaster_Shown(object sender, EventArgs e)
        {
            ...
            Party.Party_Type = "";
            Global.LOOKUPParty(LookupFromParty, Party);
            Global.LOOKUPParty(LookupBillToParty, Party);
            Party = null;
        ...
        private void gridView2_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            if (e.RowHandle >= 0)
            {
                if (e.Clicks == 2)
                {
                    ...
                    txtPurchaseMasterID.Text = Val.ToString(DRow["ItemSaleMasterID"]);
                    ...
                    LookupBillToParty.EditValue = Val.ToInt64(DRow["ShipTo_Ledger_Code"]);
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            //for (int i = dtpur.Rows.Count; i < 25; i++)
            //{
            //    dtpur.Rows.Add();
            //}
        ...
        private void GrdPurchase_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.F9)
            {
                if (Global.Confirm("Are you sure delete selected row?", "STORE", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
                {
                    ...
                    Int64 ItemPurchaseMasterID = Val.ToInt64(dgvPurchase.GetFocusedRowCellValue("ItemSaleMasterID").ToString());
                    Invoice_EntryProperty.ItemPurchaseMasterID = Val.ToInt64(ItemPurchaseMasterID);
                    Invoice_EntryProperty.ItemPurchaseDetailID = Val.ToInt64(dgvPurchase.GetFocusedRowCellValue("ItemSaleDetailID").ToString());
        ...
        private void chkToPartySame_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                LookupBillToParty.Text = LookupFromParty.Text;
                LookupBillToParty.EditValue = LookupFromParty.EditValue;
            }
        }

...
{
    public class ItemSalesMaster
    {
        InterfaceLayer Ope = new InterfaceLayer();

        #region Other Function

        public int Save(Item_Sales_Master pClsProperty)
        {
            ...
            Request.CommandText = "Item_Sales_Master_Save";
        ...
        public DataTable GetData(int ReferenceNo)
        {
            ...
            Request.CommandText = "Item_Sales_Master_Search_GetData";
            Request.CommandType = CommandType.StoredProcedure;
            Ope.GetDataTable(BLL.DBConnections.ConnectionString, BLL.DBConnections.ProviderName, DTab, Request, "");
            return DTab;
        }

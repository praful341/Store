    ...
    public partial class FrmGReportViewer : Form
    {
        ...
        private void Export(string format, string dlgHeader, string dlgFilter)
        {
            ...
            try
            {
                ...
                if (Global.Confirm("Export Done\n\nYou Want To Open Excel File ?", "Billing", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
                {
        ...
        public void FillGrid()
        {
            ...
            try
            {
                ...
                else if (ReportHeaderName.ToString() == "Item Sale Entry")
                {
                    GridView1.Columns["SGST Amt"].Summary.Add(SummaryItemType.Sum, "SGST Amt");
                    GridView1.GroupSummary.Add(SummaryItemType.Sum, "SGST Amt", GridView1.Columns["SGST Amt"]);
                    GridView1.Columns["CGST Amt"].Summary.Add(SummaryItemType.Sum, "CGST Amt");
                    GridView1.GroupSummary.Add(SummaryItemType.Sum, "CGST Amt", GridView1.Columns["CGST Amt"]);
                    GridView1.Columns["IGST Amt"].Summary.Add(SummaryItemType.Sum, "IGST Amt");
                    GridView1.GroupSummary.Add(SummaryItemType.Sum, "IGST Amt", GridView1.Columns["IGST Amt"]);
                    GridView1.Columns["Net Amount"].Summary.Add(SummaryItemType.Sum, "Net Amount");
                    GridView1.GroupSummary.Add(SummaryItemType.Sum, "Net Amount", GridView1.Columns["Net Amount"]);
                    GridView1.Columns["Gross Amt"].Summary.Add(SummaryItemType.Sum, "Gross Amt");
                    GridView1.GroupSummary.Add(SummaryItemType.Sum, "Gross Amt", GridView1.Columns["Gross Amt"]);
                    GridView1.Columns["Discount Amt"].Summary.Add(SummaryItemType.Sum, "Discount Amt");
                    GridView1.GroupSummary.Add(SummaryItemType.Sum, "Discount Amt", GridView1.Columns["Discount Amt"]);
                }
                else if (ReportHeaderName.ToString() == "Item Material Sale Entry")
                {
                    GridView1.Columns["SGST Amt"].Summary.Add(SummaryItemType.Sum, "SGST Amt");
                    GridView1.GroupSummary.Add(SummaryItemType.Sum, "SGST Amt", GridView1.Columns["SGST Amt"]);
                    GridView1.Columns["CGST Amt"].Summary.Add(SummaryItemType.Sum, "CGST Amt");
        ...
        public void Export(string format, GridView gvExportGrid, bool isHeaderPrint = true)
        {
            try
            {
                ...
                //if (Global.Confirm("Export Done\n\nYou Want To Open Excel File ?") == System.Windows.Forms.DialogResult.Yes)
                //{
                //    System.Diagnostics.Process.Start(Filepath);
                //}
            }
        ...
        private void Email_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            string StrFile = Global.DataGridExportToExcel(GridView1, lblReportHeader.Text);

...
{
    public partial class FrmMaterialSaleEntry : Form
    {
        ...
        public FrmMaterialSaleEntry(string Type_)
        {
            InitializeComponent();
            Form_Type = Type_;
        }
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            //DataTable DTab = ObjInvoiceEntry.GetData_Material(Invoice_EntryProperty);
        ...
        public Invoice_EntryProperty SaveItemPurchaseMaster()
        {
            ...
            Invoice_EntryProperty.Payment_Days = Val.ToString(0);
            Invoice_EntryProperty.Payment_Date = Val.DBDate("");
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataRow DRow in DTab.Rows)
            {
                ...
                Invoice_EntryProperty.Rate = Val.ToDecimal(DRow["Rate"]);
            ...
            if (IntRes != 0)
            {
                ...
                FrmReportViewer.ShowForm("Material_Sale_Memo", 120, Report.FrmReportViewer.ReportFolder.ACCOUNT);
                Invoice_EntryPropertyNew = null;
                dtpur = null;
        ...
        private bool ValSave()
        {
            ...
            //if (!ObjInvoiceEntry.ISExists_New(txtInvoiceNo.Text, Val.ToInt64(lblMode.Tag)).ToString().Trim().Equals(string.Empty))
            //{
        ...
        private void FrmItemPurchaseMaster_Shown(object sender, EventArgs e)
        {
            ...
            Party = null;
            this.Text = "Material Sales Invoice";
        ...
        private void CalculateGridAmount(int rowindex)
        {
            try
            {
                ...
                if (Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Quantity")) == 0)
                {
                    Qty = Val.ToDouble(1);
                    //DgvSalesDetEntry.SetRowCellValue(rowindex, "Gross_Amt", Math.Round(Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "MTR")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Weight")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Rate")), 2));
                }
                else
                {
                    Qty = Math.Round(Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Quantity")), 2);
                }
                if (Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "MTR")) == 0)
                {
                    MTR = Val.ToDouble(1);
                    //DgvSalesDetEntry.SetRowCellValue(rowindex, "Gross_Amt", Math.Round(Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Quantity")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Weight")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Rate")), 2));
                }
                else
                {
                    MTR = Math.Round(Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "MTR")), 2);
                    //DgvSalesDetEntry.SetRowCellValue(rowindex, "Gross_Amt", Math.Round(Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Quantity")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "MTR")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Weight")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Rate")), 2));
                }
                if (Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Rate")) == 0)
                {
                    Rate = Val.ToDouble(1);
                    //DgvSalesDetEntry.SetRowCellValue(rowindex, "Gross_Amt", Math.Round(Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Quantity")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Weight")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Rate")), 2));
                }
                ...
                {
                    Rate = Math.Round(Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Rate")), 2);
                    //DgvSalesDetEntry.SetRowCellValue(rowindex, "Gross_Amt", Math.Round(Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Quantity")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "MTR")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Weight")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Rate")), 2));
                }
                if (Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Weight")) == 0)
                {
                    Weight = Val.ToDouble(1);
                    //DgvSalesDetEntry.SetRowCellValue(rowindex, "Gross_Amt", Math.Round(Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Quantity")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Weight")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Rate")), 2));
                }
                else
                {
                    Weight = Math.Round(Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Weight")), 2);
                    //DgvSalesDetEntry.SetRowCellValue(rowindex, "Gross_Amt", Math.Round(Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Quantity")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "MTR")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Weight")) * Val.ToDouble(DgvSalesDetEntry.GetRowCellValue(rowindex, "Rate")), 2));
                }

                DgvSalesDetEntry.SetRowCellValue(rowindex, "Gross_Amt", Math.Round(Qty * MTR * Weight * Rate, 2));

...
{
    public partial class FrmItemPurchaseMaster : Form
    {
        ...
        public FrmItemPurchaseMaster(string Type_)
        {
            InitializeComponent();
            Form_Type = Type_;
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataRow DRow in DTab.Rows)
            {
                ...
                Int64 ItemPurchaseMasterID = Val.ToInt64(DRow["ItemPurchaseMasterID"]);
                if (ItemPurchaseMasterID == 0)
                {
                    Invoice_EntryProperty.ItemPurchaseMasterID = Val.ToInt64(Newmstid);
                    Invoice_EntryProperty.ItemPurchaseDetailID = Val.ToInt64(DRow["ItemPurchaseDetailID"]);
                }
                else
                {
                    Invoice_EntryProperty.ItemPurchaseMasterID = Val.ToInt64(DRow["ItemPurchaseMasterID"]);
                    Invoice_EntryProperty.ItemPurchaseDetailID = Val.ToInt64(DRow["ItemPurchaseDetailID"]);
                }
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            //txtInvoiceNo.Text = "";
            string Invoice_No = Val.ToString(ObjInvoiceEntry.GEtMaximumID_New("Purchase"));
        ...
        private void gridView2_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            if (e.RowHandle >= 0)
            {
                if (e.Clicks == 2)
                {
                    ...
                    txtPurchaseMasterID.Text = Val.ToString(DRow["ItemPurchaseMasterID"]);
